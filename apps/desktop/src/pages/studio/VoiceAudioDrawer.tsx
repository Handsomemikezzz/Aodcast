  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 mac-scrollbar">
        {/* Voice selection */}
        <div className="rounded-2xl border border-white/5 bg-[rgba(15,15,17,0.6)] p-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-between gap-3 rounded-xl border border-white/5 bg-white/5 px-4 py-3 text-left transition-all hover:border-accent-amber/30 hover:bg-white/10 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          {voiceMenuOpen ? (
            <div className="mt-3 max-h-[220px] overflow-y-auto rounded-2xl border border-white/5 bg-[rgba(15,15,17,0.95)] backdrop-blur-xl p-2 shadow-[0_12px_36px_rgba(0,0,0,0.4)]">
        ...
        {/* Generate audio */}
        <div className="rounded-2xl border border-white/5 bg-[rgba(15,15,17,0.6)] p-4 space-y-3">
          <button
            type="button"
            ...
            className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-accent-amber hover:bg-accent-amber/95 active:scale-[0.98] transition-all px-5 text-sm font-bold text-black disabled:opacity-40 disabled:cursor-not-allowed shadow-[0_4px_16px_rgba(242,191,87,0.2)]"
          >
            {workbench.generating ? (
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-white/5 bg-[rgba(15,15,17,0.6)] p-3">
        ...
        {!workbench.audioError && activeAudioRequestState ? (
          <div className="rounded-2xl border border-white/5 bg-[rgba(15,15,17,0.6)] p-4 text-xs text-secondary space-y-2.5">
            <div className="flex items-center justify-between gap-3">
              ...
              {workbench.generating && activeAudioRequestState.phase === "running" ? (
                <button
                  ...
                  className="rounded-lg border border-white/5 bg-white/5 px-2.5 py-1 text-[10px] font-bold text-primary hover:bg-white/10 transition-all"
                >
                  Cancel
                </button>
              ) : null}
        ...
        <div className="rounded-2xl border border-white/5 bg-[rgba(15,15,17,0.6)] p-4">
          ...
          {workbench.audioSrc ? (
            <div className="flex flex-col gap-3">
              <div className="rounded-xl border border-white/5 bg-[rgba(15,15,17,0.6)] p-3">
                <div className="flex items-start justify-between gap-2 mb-3">
                  ...
                  <button
                    ...
                    className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-white/5 bg-white/5 text-secondary hover:text-primary hover:bg-white/10 transition-all shrink-0"
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="inline-flex h-10 items-center justify-center gap-1.5 rounded-xl border border-white/5 bg-white/5 text-xs font-bold text-primary hover:bg-white/10 transition-all"
                >
                ...
                <button
                  ...
                  className="inline-flex h-10 items-center justify-center gap-1.5 rounded-xl border border-red-500/20 bg-red-500/10 text-xs font-bold text-red-300 hover:bg-red-500/20 transition-all"
                >
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-white/10 bg-[rgba(15,15,17,0.4)] py-8 px-4 text-center">
        ...
        <button
          ...
          className="flex w-full items-center justify-between gap-2 rounded-xl border border-white/5 px-4 py-3 text-sm font-medium text-secondary hover:text-white hover:bg-white/5 transition-colors"
        >
