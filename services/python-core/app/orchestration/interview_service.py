...
class InterviewOrchestrator:
    ...
    def start_interview(self, session_id: str) -> InterviewTurnResult:
        ...
        return InterviewTurnResult(
            ...
            prompt_input=prompt_input,
            next_question=None,
            ai_can_finish=readiness.can_offer_script,
        )
    ...
    def submit_user_response_stream(
        ...
        *,
        ...
        # Content may already be draftable, but never hard-stop the interview.
        # Keep digging via the LLM; soft_ready option mode carries the soft remind.
        project.session.transition(SessionState.INTERVIEW_IN_PROGRESS)
