...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--list-voice-profiles", action="store_true", help="List reusable Voice Studio profiles.")
    parser.add_argument("--create-voice-profile", default="", help="Create a reusable Voice Studio profile with this name.")
    parser.add_argument("--update-voice-profile", default="", help="Rename a reusable Voice Studio profile id.")
    parser.add_argument("--delete-voice-profile", default="", help="Delete a reusable Voice Studio profile id.")
    parser.add_argument("--select-voice-profile", default="", help="Select a reusable Voice Studio profile id.")
