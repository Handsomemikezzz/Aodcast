...
HTTP_BRIDGE_CONTRACTS: tuple[BridgeContract, ...] = (
    ...
    BridgeContract("saveEditedScript", "save_edited_script", "PUT", "/api/v1/sessions/{session_id}/script/final", "save_script", ("--save-script", "session-123", "--script-final-text", "draft"), "P1-complete"),
    BridgeContract("deleteScript", "delete_script", "POST", "/api/v1/sessions/{session_id}/script:delete", "delete_script", ("--delete-script", "session-123"), "P1-complete"),
    BridgeContract("restoreScript", "restore_script", "POST", "/api/v1/sessions/{session_id}/script:restore", "restore_script", ("--restore-script", "session-123"), "P1-complete"),
    BridgeContract("listScriptRevisions", "list_script_revisions", "GET", "/api/v1/sessions/{session_id}/script/revisions", "list_script_revisions", ("--list-script-revisions", "session-123"), "P1-complete"),
    BridgeContract("rollbackScriptRevision", "rollback_script_revision", "POST", "/api/v1/sessions/{session_id}/script/revisions/{revision_id}:rollback", "rollback_script_revision", ("--rollback-script-revision", "session-123", "--revision-id", "rev-1"), "P1-complete"),
