...
- Script Workbench owns final podcast rendering and generated-audio management. Voice Studio owns reusable voice profiles, preview, and script voice selection. Legacy take endpoints are compatibility surfaces only—prefer removal over expanding them.
